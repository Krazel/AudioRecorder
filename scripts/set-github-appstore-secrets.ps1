...
$AppleTeamId | & $GhPath secret set APPLE_TEAM_ID
$keyId | & $GhPath secret set ASC_KEY_ID
$issuerId | & $GhPath secret set ASC_ISSUER_ID
$privateKeyBase64 | & $GhPath secret set ASC_PRIVATE_KEY_BASE64

Write-Host "Secrets de App Store Connect actualizados en GitHub."
