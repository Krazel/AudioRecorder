...
if (!hasAccessToAllBuilds && !linkedBefore.some((candidate) => candidate.id === build.id)) {
...
const linked = linkedAfter.some((candidate) => candidate.id === build.id);
