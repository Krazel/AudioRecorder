...
- Captura continua mediante un unico `AVAudioEngine` en ambos modos; la separacion cambia el archivo de salida sin detener el microfono.
...
- Ejecutar la puerta XCTest/macOS preparada antes de generar una build 1.0.3.
