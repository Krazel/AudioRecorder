...
- El commit `f6cfcad` añadió una operación protegida que solo puede modificar `promotionalText`. El run [33451128043](https://github.com/Krazel/AudioRecorder/actions/runs/33451128043) guardó y volvió a leer correctamente los siete textos en App Store Connect. La versión siguió `WAITING_FOR_REVIEW`; no se tocaron `What's New`, build, submission ni publicación.
